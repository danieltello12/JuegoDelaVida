...
public class InicioSesionPropertiesNP {
    protected IniciosesionModelNP original;
    private StringProperty nombre = new SimpleStringProperty();
    private StringProperty contraseña= new SimpleStringProperty();

    public InicioSesionPropertiesNP(IniciosesionModelNP original) {
    ...
    public void setOriginal(IniciosesionModelNP original){
